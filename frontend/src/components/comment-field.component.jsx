...
const CommentField = ({ action, index = undefined, replyingTo = undefined, setReplying }) => {
    ...
    let { blog, setBlog, blog: { _id, author: { _id: blog_author }, comments: { results: commentsArr }, comments, activity, activity: { total_comments, total_parent_comments }, setTotalParentCommentsLoaded }} = useContext(BlogContext)
    ...
    return(
        <>
            <Toaster />
            <textarea className="input-box pl-5 placeholder:text-dark-grey resize-none h-[150px] overflow-auto" onChange={(e) => setComment(e.target.value)} value={comment} placeholder="Leave a comment..."></textarea>
