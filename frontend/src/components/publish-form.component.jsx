...
const PublishForm = () => {
        ...
        if(e.keyCode == 13 || e.keyCode == 188) {
            ...
            if(tags.length < tagLimit) {
                if(!tags.includes(tag) && tag.length) {
                    ...
                    toast.error(`You can add max ${tagLimit} limit`)
                }
            }
    ...
    return(
        <AnimationWrapper>
            <section className='w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:top-[10%]'>
                <Toaster/>
                ...
                <div className='max-w-[550px] center'>
                    ...
                    <div className='border-grey lg:border-1 lg:pl-8'>
                        ...
                        <input className='input-box pl-4' onChange={handleBlogTitleChange} type="text" placeholder='Blog Title' defaultValue={title} />

                        <p className='text-dark-grey mb-2 mt-9'>Short description about your blog</p>

                        <textarea onKeyDown={handleTitleKeyDown} onChange={handleBlogDesChange} maxLength={characterLimit} defaultValue={des} className='h-40 resize-none leading-7 input-box pl-4'>
                        </textarea>

                        <p className='mt-1 text-dark-grey text-sm text-right'>{ characterLimit - des.length } characters left</p>
                    
                        <p className='text-dark-grey mb-2 mt-9'>Topics - ( Helps is searching and rankin your blog post )</p>
